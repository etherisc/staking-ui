...
import { IInstanceService, IInstanceService__factory, IRegistry__factory } from "../contracts/gif-interface-contracts";
import { IBundle } from "../contracts/gif-interface-contracts/IInstanceService";
